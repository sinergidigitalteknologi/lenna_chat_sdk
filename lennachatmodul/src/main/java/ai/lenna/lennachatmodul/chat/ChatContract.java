...
public interface ChatContract {
    ...
    interface View {
        ...
        void showBottomSheetZakatFitrahDialog(ChatOutputZakatFitrah chatOutputZakatFitrah);
        void showBottomSheetZakatProfesihDialog(ChatOutputZakatProfesi chatOutputZakatProfesi);
        void showBottomSheetDataMuzakiDialog(ChatOutputDataMuzaki chatOutputDataMuzaki);
        void showBottomSheetZakatMaaliDialog(ChatOutputZakatMaal chatOutputZakatMaal);
