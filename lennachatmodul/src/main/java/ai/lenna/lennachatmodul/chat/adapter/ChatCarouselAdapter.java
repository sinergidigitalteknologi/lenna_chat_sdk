...
public class ChatCarouselAdapter extends RecyclerView.Adapter<ChatCarouselAdapter.ChatCarouselItemVH> {

    ArrayList<ChatColumnCarousel> chatColumnCarousels;
    List<ChatActionCarousel> actions;
    ChatPostCallBack chatGridCallBack;

    public ChatCarouselAdapter(ArrayList<ChatColumnCarousel> chatColumnCarousels, ChatPostCallBack chatGridCallBack) {
    ...
    private void actionButton(ChatCarouselItemVH chatCarouselItemVH, String typeAction, int position, int positionItem) {
        switch (typeAction) {
            case "postback":
