...
public class ChatPresenter implements ChatContract.Presenter, ChatContract.Model.OnFinishedListener {
    ...
    private static final String TYPE_FORM_ZAKAT_FITRAH = "zakatFitrahForm";
    private static final String TYPE_FORM_ZAKAT_PROFESI = "zakatProfesiForm";
    private static final String TYPE_FORM_DATA_MUZAKI = "muzakiForm";
    private static final String TYPE_FORM_ZAKAT_MAAL = "zakatMaalForm";
    ...
    ChatRespOpenAppVH chatRespOpenAppVH;
...
//                chatResponse.setDate(chatResp.getDate());
            ...
            case TYPE_FORM_ZAKAT_FITRAH:
                if (!sourceType.equals("history")){
                    ChatOutputZakatFitrah chatOutputZakatFitrah = new Gson().fromJson(json, ChatOutputZakatFitrah.class);
                    view.showBottomSheetZakatFitrahDialog(chatOutputZakatFitrah);
                }
                break;
            case TYPE_FORM_ZAKAT_PROFESI:
                if (!sourceType.equals("history")){
                    ChatOutputZakatProfesi chatOutputZakatProfesi = new Gson().fromJson(json, ChatOutputZakatProfesi.class);
                    view.showBottomSheetZakatProfesihDialog(chatOutputZakatProfesi);
                }
                break;
            case TYPE_FORM_DATA_MUZAKI:
                if (!sourceType.equals("history")){
                    ChatOutputDataMuzaki chatOutputDataMuzaki = new Gson().fromJson(json, ChatOutputDataMuzaki.class);
                    view.showBottomSheetDataMuzakiDialog(chatOutputDataMuzaki);
                }
                break;
            case TYPE_FORM_ZAKAT_MAAL:
                if (!sourceType.equals("history")){
                    ChatOutputZakatMaal chatOutputZakatMaal = new Gson().fromJson(json, ChatOutputZakatMaal.class);
                    view.showBottomSheetZakatMaaliDialog(chatOutputZakatMaal);
                }
